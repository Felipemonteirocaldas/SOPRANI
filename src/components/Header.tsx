        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-col space-y-4">
            <Link
              ...
              className="flex items-center gap-3 text-base font-bold text-white bg-accent p-4 rounded-2xl shadow-lg shadow-accent/20 hover:bg-red-700 hover:shadow-accent/30 transition-all duration-300 group/item"
              onClick={onClose}
            >
