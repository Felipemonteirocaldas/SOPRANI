            ...
            >
              ...
              <motion.div layout className="flex items-center space-x-2 md:space-x-4">
                <div className="hidden md:flex items-center border-l border-gray-100 pl-2 md:pl-3 mx-1 md:mx-2 relative group">
                  <button className="flex items-center text-sm font-bold text-primary hover:text-accent transition-colors py-2 px-2">
              ...
              <div className="flex flex-col space-y-2 px-6 pt-6 pb-20 shadow-inner">
                ...
                <div className="pt-4 border-t border-gray-100">
                  <button 
                    ...
                    className="flex items-center justify-between w-full py-2 text-base font-bold text-primary"
                  >
                    <span>{t('header.language')} ({i18n.language?.toUpperCase() || 'EN'})</span>
                    <ChevronDown size={16} className={cn("transition-transform", mobileLangOpen && "rotate-180")} />
                  </button>
                      ...
                      {languages.map((lang) => (
                        <button
                          ...
                          className={cn(
                            ...
                            i18n.language === lang.code ? "bg-accent text-white shadow-lg shadow-accent/20" : "bg-slate-50 text-primary"
                          )}
                        >
                          {lang.label}
                        </button>
