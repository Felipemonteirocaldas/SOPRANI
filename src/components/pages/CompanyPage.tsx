      ...
      <section className="py-12 sm:py-16 md:py-20 bg-background">
        <div className="container mx-auto px-4">
          <AnimatedElement>
            ...
            <p className="text-base sm:text-lg text-gray-600 text-center mb-8 sm:mb-12 max-w-3xl mx-auto line-clamp-1">A global network of specialized partners providing industrial solutions for the metal packaging sector.</p>
          </AnimatedElement>
